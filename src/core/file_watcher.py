...
class DebouncedFileHandler(FileSystemEventHandler):
    def __init__(self, callback, debounce_seconds: float = 10.0, watch_path: str = ""):
        super().__init__()
    ...
    def _trigger_sync(self):
        ...
        if files and self.callback:
            self.callback(self.watch_path, files)
...
class FileWatcher:
    def __init__(self, watch_path: str, debounce_seconds: float = 10.0,
        ...
        self._handler = DebouncedFileHandler(callback, debounce_seconds, watch_path)
